...
import (
	...
	communicatorMocks "github.com/fibanez/session-manager-plugin/src/communicator/mocks"
	"github.com/fibanez/session-manager-plugin/src/config"
	"github.com/fibanez/session-manager-plugin/src/encryption"
	"github.com/fibanez/session-manager-plugin/src/encryption/mocks"
